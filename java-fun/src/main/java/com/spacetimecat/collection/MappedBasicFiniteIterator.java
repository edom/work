...
final class MappedBasicFiniteIterator<A, B> implements BasicFiniteIterator<B>
{
    private final BasicFiniteIterator<A> bi;
    private final BasicFunction1<? super A, B> f;

    MappedBasicFiniteIterator (BasicFiniteIterator<A> bi, BasicFunction1<? super A, B> f)
    {
        this.bi = bi;
        this.f = f;
    }
