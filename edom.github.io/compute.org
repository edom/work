...
** The English suffix -ion means process
...
On the other hand, an explosion is an action or a result, but not a process, and not a condition, and not a state.
...
** Analog and digital computers compute what and how?
...
But each voltage \(v_k\) should be thought as a random variable, not a number.
...
** The common thing to all computers is what?
...
** The subject and object of the verb "compute" are what?
