...
** What is the everyday meaning of computation?
...
Nevertheless, modernization does not change the nature of computation model:
...
reverse mathematics[fn::https://en.wikipedia.org/wiki/Reverse_mathematics#The_big_five_subsystems_of_second-order_arithmetic],
and so on.
They are related to each other.
One goal of such hierarchies is to find out which feature gives which power.
* Computation models
