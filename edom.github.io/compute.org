...
#+MATHJAX: yes
* What is computation?
Here we analyze the meaning of computation.
** What do the subjects and objects of the verb "compute" imply about what computation is?
...
in the same way an English text describing how to count does not itself count.
An English text has no material existence; what has material existence is some ink on paper;
English is our interpretation of the pattern formed by that ink.
