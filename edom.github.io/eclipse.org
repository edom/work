...
* How do we get paid to develop Eclipse while still retaining all my IPs?
...
* How to run the Eclipse Provisioning RCP Agent?
...
Install New Software > EclipseRT Target Platform Components > Equinox Target Components?
No effect?
