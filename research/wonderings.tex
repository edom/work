...
It is not your fault that you did not pass the audition.
The auditor just had a different taste.
\emph{It's pure feeling.}
There is no reason.
Imagine yourself as a different person who does the audit.

Imagine that you just saw a beautiful person,
but you did not want to get to know him/her more.
That's similar to why you did not pass the audition.
It's all about unexplainable feelings and tastes.

Audition is like finding a couple.

It only takes you \emph{two seconds} to unconsciously
decide whether you like a person you just saw.

The only way to pass an audition is to get into more auditions.
