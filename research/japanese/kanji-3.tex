...
(?) \ruby{教}{キョウ}\ruby{室}{シツ}で眠るな。Don't sleep in the classroom.
...
\ruby{結婚}{ケッコン}するな！Don't get married!
...
４\ruby{歳}{サイ}\ruby{女}{ジョ}\ruby{児}{ジ}\ruby{死}{シ}\ruby{亡}{ボウ}%
　きょうだい２人\ruby{重}{ジュウ}\ruby{体}{タイ}
}{
Fire in a large apartment: 4-year girl dead, 2 people in critical state.
}
...
\sbs{
    \ruby{A}{エイ}\ruby{T}{ティ}\ruby{M}{エム}から\ruby{金}{かね}を\ruby{引}{ひ}き\ruby{出}{だ}した。
}{
...
\sbs{
    あの人は、「子供の頃で、早く\ruby{大人}{おとな}になりたかった。
    大人になった\ruby{後}{あと}で、子供の頃に戻りたい。
    大人になりたくない。」と言った。
}{
    That person said,
    ``When I was a child, I wanted to become an adult quickly.
    After becoming an adult, I want to go back to my childhood.
...
(?) \ruby{寒}{さむ}い冬の風は、池が\ruby{凍}{こお}った。
...
部屋に\ruby{戻}{もど}れ！Go back to (your) room!
