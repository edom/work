...
\sbs{
    \ruby{人}{ひと}がいる。
    \ruby{三}{サン}\ruby{人}{ニン}だ。
    \ruby{日}{ニ}\ruby{本}{ホン}\ruby{人}{ジン}だ。
    \ruby{一人}{ひとり}じゃない。
}{
    There are people.
    It's three people.
...
\sbs{
    あの\ruby{大}{おお}きい\ruby{犬}{いぬ}は人に\ruby{吠}{ほ}える。
}{
    That big dog barks at people.
}
...
\sbs{
    (?) \ruby{10}{ジュウ}\ruby{年}{ネン}の\ruby{働}{はたら}く\ruby{後}{あと}で、\ruby{父}{ちち}は太った。
}{
    After working 10 years, father got fat.
}

\sbs{
    (?) お\ruby{父}{とう}さんの\ruby{仕}{シ}\ruby{事}{ごと}は？
}{
...
立ち\ruby{上}{あ}がって\ruby{下}{くだ}さい。Please stand up.

\section{2 入ヒ七匕 4 区凶 5 兄}

入（ニュウ）enter.

(?) 入るな！\ruby{入}{ニュウ}\ruby{浴}{ヨク}しているよ！
...
\ruby{眉間}{ミケン}の皺glabellar wrinkle; the wrinkle between the eyebrows.
...
解消（カイショウ）cancellation; resolution; reduction (e.g. of stress).
